...
//	__m128 TestSSEmatrix3[4];
	...
	//Easy_vector_norm2(&TestSSE,TestSSEnorm2);
	//Testfloatnorm2=Easy_vector_norm2(TestSSEnorm2);
	Easy_quat_normalize(&TestSSE,TestSSE);
	Easy_quat_normalize(TestFloat);
